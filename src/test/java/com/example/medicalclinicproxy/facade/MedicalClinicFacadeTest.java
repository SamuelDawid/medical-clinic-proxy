...
//        when(clinicClient.getDoctorsBySpeciality(CARDIOLOGY, pageable.getPageNumber(), pageable.getPageSize())).thenReturn(expected);
//        //When
//        PageDto<DoctorSummaryDto> result = facade.getDoctorsFromSpecificSpeciality(CARDIOLOGY, pageable);
//        //Then
//        assertEquals(expected, result);
//        verify(clinicClient).getDoctorsBySpeciality(CARDIOLOGY, pageable.getPageNumber(), pageable.getPageSize());
//    }
//
//    @Test
...
//        //Given
//        Pageable pageable = PageRequest.of(0, 20);
//        when(clinicClient.getDoctorsBySpeciality(CARDIOLOGY, pageable.getPageNumber(), pageable.getPageSize())).thenThrow(new IllegalStateException("Connection refused"));
//        //When + Then
//        MedicalClinicUnavailableException exception = assertThrows(MedicalClinicUnavailableException.class,
